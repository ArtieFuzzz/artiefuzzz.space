...
<template>
  <div>
    <NodedotjsIcon style='fill: #339933; margin-right: 0.28rem' size='24' />
    <RustIcon style='fill: #FFFFFF' class='spacing' size='24' />
    <ElixirIcon style='fill: #4B275F' class='spacing' size='24' />
    <TypescriptIcon style='fill: #3278C6' class='spacing' size='24' />
    <Html5Icon style='fill: #E34F26' class='spacing' size='24' />
    ...
    <PostgresqlIcon style='fill: #FFFFFF' class='spacing' size='24' />
    <PowershellIcon style='fill: #5392FF' class='spacing' size='24' />
    <VisualstudiocodeIcon style='fill: #007ACC' class='spacing' />
  </div>
</template>
